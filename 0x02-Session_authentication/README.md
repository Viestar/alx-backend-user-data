...
mandatory
Score: 13.33% (Checks completed: 26.67%)
...
You must use self.session_cookie(...) and self.user_id_for_session_id(...) to return the User ID based on the cookie_my_session_id
